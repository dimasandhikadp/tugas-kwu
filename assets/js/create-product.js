...
function updateCardStyles() {
    document.querySelectorAll('label input[type="checkbox"], label input[type="radio"]').forEach(input => {
    ...
    gambarInput.addEventListener('change', function(e) {
        ...
        files.forEach((file) => {
            ...
            reader.onload = function(event) {
                ...
                card.className = "relative group border border-slate-200 rounded-xl overflow-hidden aspect-square bg-slate-100 shadow-sm animate-fade-in";
